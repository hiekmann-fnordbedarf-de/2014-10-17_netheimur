#!/bin/bash
################################################################################
# Script for Uninstallation: ODOO Saas4/Trunk server on Ubuntu 14.04 LTS
# Based on Installation script of André Schenkels, ICTSTUDIO 2014
# Author: Hiekmann
#-------------------------------------------------------------------------------
#  
# This script will uninstall ODOO Server after a clean install by Anré Schenkels
# installation script
#-------------------------------------------------------------------------------
# USAGE:
#
